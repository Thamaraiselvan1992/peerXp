<?php 
        ...
        CURLOPT_URL => "https://desk.zoho.in/api/v1/tickets?include=contacts,assignee,departments,team,isRead",
...
$ticketList =json_decode($response,true);
// echo "<pre>";print_r($ticketList['data']);
$i =1;
$statusOpen = 0;
$statusClosed = 0;
$statusOnHold = 0;
